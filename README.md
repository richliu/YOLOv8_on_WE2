...
- Second, add the following command at the `ultralytics repository` https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/exporter.py#L709C2-L709C76 . (please reference the tutorial [here](https://github.com/PINTO0309/onnx2tf?tab=readme-ov-file#parameter-replacement))
    ```
